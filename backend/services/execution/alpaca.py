...
class AlpacaTrader(BaseTraderInterface):
    ...
    async def get_current_price(self, ticker: str) -> float | None:
        ...
        # Querying Yahoo Finance is generally faster and doesn't hit Alpaca's rate limits
    ...
    async def place_order(self, request: OrderRequest) -> OrderResult:
        ...
        # Build order body
        # Alpaca requires qty to be a string
        # Limit to 4 decimal places for fractional shares
        ...
        # Setup bracket orders for stop-loss and take-profit
        ...
        try:
            async with httpx.AsyncClient() as client:
                ...
                # Extract immediately if present in the initial response
                filled_price = None
                filled_qty = None
                ...
                # Market orders are filled immediately. We poll for up to 3 seconds to get the fill price if not yet filled.
                for _ in range(6):
                ...
                # If status is still not filled, fetch one last time to get details
                ...
                # Fallback filled price/qty to requested if Alpaca says filled but didn't return price yet
