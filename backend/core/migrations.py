...
_NEW_COLUMNS: list[tuple[str, str, str]] = [
    ...
    ("app_settings", "memory_ollama_embed_model", "VARCHAR(60) DEFAULT 'nomic-embed-text'"),
    ("app_settings", "fallback_llm_provider", "VARCHAR(50)"),
    ("app_settings", "fallback_llm_model", "VARCHAR(100)"),
    ...
    ("app_settings", "analyst_prefilter_enabled", "BOOLEAN DEFAULT FALSE"),
