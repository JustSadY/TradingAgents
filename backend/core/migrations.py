...
_ALLOWED_COLUMNS = {
    ...
    "analysis_results": {
        ...
        "strategy_id",
        "strategy_before_version",
        "strategy_after_version",
        "analysis_mode",
        "learning_eligible",
        "degraded",
        "failed_agents",
...
_NEW_COLUMNS: list[tuple[str, str, str]] = [
    ...
    ("analysis_results", "analysis_plan_json", "JSON"),
    ("analysis_results", "synthesis_json", "JSON"),
    ("analysis_results", "market_regime_json", "JSON"),
    ("analysis_results", "strategy_before_json", "JSON"),
    ("analysis_results", "strategy_after_json", "JSON"),
    ("analysis_results", "strategy_candidate_json", "JSON"),
    ("analysis_results", "pm_proposal_json", "JSON"),
    ("analysis_results", "portfolio_decision_json", "JSON"),
    ("analysis_results", "decision_transition_json", "JSON"),
    ("analysis_results", "calibrated_confidence", "FLOAT"),
    ("analysis_results", "strategy_update_status", "VARCHAR(30)"),
    ("analysis_results", "strategy_id", "INTEGER"),
    ("analysis_results", "strategy_before_version", "INTEGER"),
    ("analysis_results", "strategy_after_version", "INTEGER"),
    ("analysis_results", "analysis_mode", "VARCHAR(20) DEFAULT 'live'"),
    ("analysis_results", "learning_eligible", _TYPE_BOOLEAN_DEFAULT_TRUE),
    ...
    ("app_settings", "strategy_learning_enabled", _TYPE_BOOLEAN_DEFAULT_TRUE),
    ("app_settings", "decision_stability_mode", "VARCHAR(20) DEFAULT 'shadow'"),
    ("app_settings", "decision_stability_min_quality", "INTEGER DEFAULT 70"),
    ("app_settings", "decision_stability_min_confidence", "FLOAT DEFAULT 0.65"),
    ("app_settings", "decision_stability_min_evidence_groups", "INTEGER DEFAULT 2"),
    ("app_settings", "reversal_verifier_enabled", _TYPE_BOOLEAN_DEFAULT_TRUE),
    ("app_settings", "confidence_calibration_enabled", _TYPE_BOOLEAN_DEFAULT_FALSE),
    ("app_settings", "regime_aware_weighting_enabled", _TYPE_BOOLEAN_DEFAULT_FALSE),
