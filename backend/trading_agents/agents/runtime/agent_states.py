...
class StateKeys:
    ...
    # Legacy-only fields retained so completed historical analysis rows can be
    # read without migration. New graph runs never populate a Trader proposal.
    TRADER_INVESTMENT_PLAN = "trader_investment_plan"
    TRADER_PROPOSAL_JSON = "trader_proposal_json"
...
class AgentState(MessagesState):
    ...
    trader_investment_plan: Annotated[str, "Legacy Trader plan retained only for historical analysis records"]
    trader_proposal_json: Annotated[str, "Legacy Trader proposal JSON retained only for historical analysis records"]
