const translations = {
  en: {
    ...
    'settings.historical_analyses_hint': 'Include previous reports for AI (last 5 analyses)',
  ...
  tr: {
    ...
    'settings.historical_analyses_hint': 'Önceki raporları AI\'ya dahil et (son 5 analiz)',
