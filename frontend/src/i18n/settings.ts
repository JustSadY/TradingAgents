const translations = {
  en: {
    ...
    'settings.cron_next_run': 'Next Run',
    ...
    'settings.cron_degraded': 'Scheduler Core Degraded',
    'settings.cron_reason_scheduler_not_initialized': 'The scheduler has not been initialised in this process.',
    'settings.cron_reason_scheduler_stopped': 'The scheduler is not running.',
    'settings.cron_reason_scheduler_stalled': 'The scheduler is not responding — no heartbeat.',
    'settings.cron_reason_bootstrap_failed': 'Stored schedules could not be loaded at startup.',
    'settings.cron_reason_job_missing': 'Scans are enabled but no job is registered; it is restored automatically.',
    'settings.cron_registered_schedule': 'Registered Schedule',
    'settings.cron_heartbeat': 'Heartbeat',
    'settings.cron_heartbeat_seconds_ago': '{{seconds}}s ago',
    'settings.cron_last_run': 'Last Run',
    'settings.cron_never_ran': 'Never run',
    'settings.cron_last_outcome': 'Last Outcome',
    'settings.cron_outcome_ok': 'Completed',
    'settings.cron_outcome_skipped': 'Skipped',
    'settings.cron_outcome_error': 'Failed',
    'settings.cron_outcome_missed': 'Missed its run time',
    'settings.cron_outcome_running': 'Running',
    'settings.cron_no_job': 'No scan job is registered for this account.',
    ...
    'settings.row_auto_execute_signals': 'Automatically Execute AI Signals',
    'settings.auto_execute_signals_hint': 'Off by default. When enabled, a final Buy/Sell signal may place a paper/live order only after every safety and risk check passes.',
    ...
    'settings.strategy_continuity_hint': 'Shadow mode records the controller\'s counterfactual without changing the Portfolio Manager\'s executable decision.',
    'settings.row_strategy_learning': 'Learn Active Asset Strategies',
    'settings.strategy_learning_hint': 'Persist live strategy revisions and use them as context for later analyses.',
    ...
    'settings.decision_stability_enforce_warning': 'Enforce can replace a proposal with Hold when change evidence is insufficient.',
    ...
    'settings.row_reversal_verifier': 'Verify Major Reversals',
    'settings.reversal_verifier_hint': 'Require an extra independent-evidence check before a major BUY↔SELL reversal is accepted.',
    'settings.row_confidence_calibration': 'Calibrate PM Confidence',
    'settings.confidence_calibration_hint': 'Use realised outcomes to adjust raw Portfolio Manager confidence before stability checks.',
    'settings.row_regime_aware_weighting': 'Regime-Aware Analyst Weighting',
    'settings.regime_aware_weighting_hint': 'Weight analyst history by the current market regime when enough realised evidence exists.',
  ...
  tr: {
    ...
    'settings.cron_next_run': 'Sonraki Çalışma',
    ...
    'settings.cron_degraded': 'Zamanlayıcı Çekirdeği Sorunlu',
    'settings.cron_reason_scheduler_not_initialized': 'Zamanlayıcı bu süreçte başlatılmamış.',
    'settings.cron_reason_scheduler_stopped': 'Zamanlayıcı çalışmıyor.',
    'settings.cron_reason_scheduler_stalled': 'Zamanlayıcı yanıt vermiyor — kalp atışı yok.',
    'settings.cron_reason_bootstrap_failed': 'Kayıtlı zamanlamalar açılışta yüklenemedi.',
    'settings.cron_reason_job_missing': 'Taramalar etkin ama kayıtlı iş yok; otomatik olarak geri yükleniyor.',
    'settings.cron_registered_schedule': 'Kayıtlı Zamanlama',
    'settings.cron_heartbeat': 'Kalp Atışı',
    'settings.cron_heartbeat_seconds_ago': '{{seconds}} sn önce',
    'settings.cron_last_run': 'Son Çalışma',
    'settings.cron_never_ran': 'Hiç çalışmadı',
    'settings.cron_last_outcome': 'Son Sonuç',
    'settings.cron_outcome_ok': 'Tamamlandı',
    'settings.cron_outcome_skipped': 'Atlandı',
    'settings.cron_outcome_error': 'Başarısız',
    'settings.cron_outcome_missed': 'Çalışma zamanı kaçırıldı',
    'settings.cron_outcome_running': 'Çalışıyor',
    'settings.cron_no_job': 'Bu hesap için kayıtlı tarama işi yok.',
    ...
    'settings.row_auto_execute_signals': 'AI Sinyallerini Otomatik Uygula',
    'settings.auto_execute_signals_hint': 'Varsayılan olarak kapalıdır. Açıldığında nihai Al/Sat sinyali, tüm güvenlik ve risk kontrollerini geçerse sanal/canlı emir oluşturabilir.',
    ...
    'settings.section_strategy_continuity': 'Strateji Sürekliliği ve Karar Kararlılığı',
    'settings.strategy_continuity_hint': 'Gölge mod, Portfolio Manager\'ın yürütülebilir kararını değiştirmeden controller\'ın karşı-olgusal sonucunu kaydeder.',
    'settings.row_strategy_learning': 'Aktif Varlık Stratejilerini Öğren',
    'settings.strategy_learning_hint': 'Canlı strateji revizyonlarını kalıcılaştırır ve sonraki analizlerde bağlam olarak kullanır.',
    'settings.row_decision_stability_mode': 'Karar Kararlılığı Modu',
    'settings.decision_stability_off': 'Kapalı',
    'settings.decision_stability_shadow': 'Gölge — yalnızca kaydet',
    'settings.decision_stability_enforce': 'Uygula',
    'settings.decision_stability_enforce_warning': 'Uygulama modu, değişim kanıtı yetersizse öneriyi Hold ile değiştirebilir.',
    'settings.row_stability_min_quality': 'Min. Değişim Kalitesi',
    'settings.row_stability_min_confidence': 'Min. Kalibre Güven',
    'settings.row_stability_min_evidence_groups': 'Min. Bağımsız Kanıt Grubu',
    'settings.row_reversal_verifier': 'Büyük Dönüşleri Doğrula',
    'settings.reversal_verifier_hint': 'Büyük BUY↔SELL dönüşü kabul edilmeden önce ek bağımsız kanıt kontrolü gerektirir.',
    'settings.row_confidence_calibration': 'PM Güvenini Kalibre Et',
    'settings.confidence_calibration_hint': 'Kararlılık kontrollerinden önce ham Portfolio Manager güvenini gerçekleşen sonuçlarla düzeltir.',
    'settings.row_regime_aware_weighting': 'Rejim-Farkında Analist Ağırlığı',
    'settings.regime_aware_weighting_hint': 'Yeterli gerçekleşmiş veri olduğunda analist geçmişini güncel piyasa rejimine göre ağırlıklandırır.',
