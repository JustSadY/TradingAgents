...
A modern, high-fidelity investment decision-making dashboard built with **React 19**, **TypeScript**, **Tailwind CSS 4**, and **Vite 8**. It features a glassmorphic dark-themed layout, interactive charts, and real-time streaming of multi-agent execution steps and generated reports over WebSockets.
